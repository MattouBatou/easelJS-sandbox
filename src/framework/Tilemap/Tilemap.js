 ...
 */
var Tilemap = function (stageContext, TILEMAP_PATH, tiledJson, levelId, worldWidth, worldHeight)
{
  /**
...
Tilemap.prototype.tilesetLoader = function (stageContext, path)
{
  ...
  tilesetImg.onload = function ()
  {
    ...
    self.buildMap(stageContext, buffer, self.map2d.width*self.map2d.tilewidth, self.map2d.height*self.map2d.tileheight, 0, 0);
  };
 ...
 */
Tilemap.prototype.buildMap = function (stageContext, tilesetBuffer, levelWidth, levelHeight, x, y)
{
  var self = this;

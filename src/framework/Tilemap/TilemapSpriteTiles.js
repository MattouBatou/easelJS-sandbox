...
Tilemap.prototype.tilesetLoader = function (stageContext, path)
{
 ...
 /* var buffer = document.createElement('canvas');
  ...
  var ssData ={
    images:[tilesetImg],
    frames:{ width:32, height:32, count:this.map2d.tilesets[0].tilecount, regX:0, regY:0, spacing:0, margin:0 }
  };
  this.map2d.tilesets[0].spriteSheet = new createjs.SpriteSheet(ssData);
  this.map2d.tilesets[0].container = new createjs.Container();
  this.map2d.tilesets[0].container.x = 0;
  this.map2d.tilesets[0].container.y = 0;
  this.stageRef.addChild(this.map2d.tilesets[0].container);
